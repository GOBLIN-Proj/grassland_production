...
class TestGrasslandOutput(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.path_to_data = "./geo_goblin_data/"
        cls.scenario_dataframe = pd.read_csv(os.path.join(cls.path_to_data, "scenario_input_dataframe.csv"))
        cls.scenario_animal_dataframe = pd.read_csv(os.path.join(cls.path_to_data, "future_animals.csv"))
        cls.baseline_animal_dataframe = pd.read_csv(os.path.join(cls.path_to_data, "past_animals.csv"))
