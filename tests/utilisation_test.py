...
class TestUtilisationFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scenario_animals_df = pd.read_csv(os.path.join(self.path_to_data, "scenario_animal_data.csv"))
        self.baseline_animals_df = pd.read_csv(os.path.join(self.path_to_data, "baseline_animal_data.csv"))
    ...
    def test_get_farm_type_dry_matter_produced(self):
        ...
        print(self.instance.get_farm_based_utilisation_rate())
