...
class DryMatterTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.dm_class = DryMatter("ireland", 2018, self.data_frame, self.animal_dataframe_scenarios, self.animal_dataframe_baseline)

    def test_dry_matter(self):
        
        test = self.dm_class.get_utilisation_rate()
