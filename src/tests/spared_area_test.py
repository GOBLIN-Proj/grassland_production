...
class SpatAreasTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.grassland_class = Grasslands("ireland", 2018, self.data_frame, self.animal_dataframe_scenarios, self.animal_dataframe_baseline)
    
    def test_fertilisation(self):

        test = self.grassland_class.get_non_grass_total_area()
